...
func UpdateEventController(c *fiber.Ctx) error {
	id := c.Params("id")
	payload := new(commonStructs.UpdateEventServicePayload)
	...
	serviceResponse := eventService.UpdateEventService(uuid, *payload)
